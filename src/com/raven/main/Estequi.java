 ...
 * @author paulo
 */
public class Estequi extends javax.swing.JFrame {

    /**
     * Creates new form Estequi
     */
    public Estequi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/Estequiometria.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Estequi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

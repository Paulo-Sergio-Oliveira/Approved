 ...
 * @author paulo
 */
public class Porcent extends javax.swing.JFrame {

    /** Creates new form Porcent */
    public Porcent() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/Porcent.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Porcent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

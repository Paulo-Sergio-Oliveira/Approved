 ...
 * @author paulo
 */
public class Apovoc extends javax.swing.JFrame {

    /**
     * Creates new form Apovoc
     */
    public Apovoc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/Aposto.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Apovoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

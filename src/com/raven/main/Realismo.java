 ...
 * @author paulo
 */
public class Realismo extends javax.swing.JFrame {

    /**
     * Creates new form Realismo
     */
    public Realismo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/Modernismo.png"))); // NOI18N
        jScrollPane1.setViewportView(jLabel1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 30, 970, 690));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/Realismo.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Realismo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

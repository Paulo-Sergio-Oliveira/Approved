 ...
 * @author paulo
 */
public class Fisiologia extends javax.swing.JFrame {

    /**
     * Creates new form Fisiologia
     */
    public Fisiologia() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/Fisiologia.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fisiologia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
